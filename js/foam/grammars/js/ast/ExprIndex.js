...
CLASS({
  ...
  documentation: 'Expr for an indexing expression, eg. foo[bar]. For foo.bar ' +
      'see $$DOC{ref:"foam.grammars.js.ast.ExprDot"}. Note that this is left-' +
      'associative, meaning foo[bar][baz] parses as (foo[bar])[baz].',
